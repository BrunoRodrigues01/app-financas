...
((SELECT id FROM public.usuarios WHERE email = 'bruno.rodrigues01@hotmail.com'), 
 ...
 'Sua assinatura do Netflix será renovada em 7 dias (R$ 39,90)', 
 false),
...
-- ==================== RESUMO ====================
-- ✅ Premium ativado
-- ✅ 39 transações em Janeiro (8 receitas + 31 despesas)
-- ✅ 9 transações em Fevereiro até 08/02 (2 receitas + 7 despesas)
-- ✅ 4 metas financeiras
-- ✅ 8 limites de categoria (4 por mês)
-- ✅ 1 assinatura premium ativa (anual R$ 99,00)
-- ✅ 5 notificações

-- Total de Receitas Janeiro: R$ 8.000,00
-- Total de Despesas Janeiro: R$ 6.329,20
-- Saldo Janeiro: R$ 1.670,80

-- Total de Receitas Fevereiro: R$ 7.200,00
-- Total de Despesas Fevereiro: R$ 835,00
-- Saldo Fevereiro até agora: R$ 6.365,00
